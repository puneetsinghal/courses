...
obstacles = [];
% tic 
% [r, p, y, fval] = part1(target, link_length, ...
%     min_roll, max_roll, min_pitch, max_pitch, min_yaw, max_yaw, obstacles);
% toc
% [~, ee_x, ee_y, ee_z, q0, q1, q2, q3] = forwardKinematics([r;p;y]);
% position1 = [ee_x, ee_y, ee_z, q0, q1, q2, q3]
% error_part1 = ((target-position1)*...
%     (target-position1)')/norm(target)
% 


tic 
[r, p, y, fval] = part2(target, link_length, ...
    min_roll, max_roll, min_pitch, max_pitch, min_yaw, max_yaw, obstacles);
toc
[~, ee_x, ee_y, ee_z, q0, q1, q2, q3] = forwardKinematics([r;p;y]);
...
% tic 
% [r, p, y, fval] = part3(target, link_length, ...
%     min_roll, max_roll, min_pitch, max_pitch, min_yaw, max_yaw, obstacles);
% toc
% [~, ee_x, ee_y, ee_z, q0, q1, q2, q3] = forwardKinematics([r;p;y]);
% position3 = [ee_x, ee_y, ee_z, q0, q1, q2, q3]
% error_part3 = ((target-position3)*...
%     (target-position3)')/norm(target)
